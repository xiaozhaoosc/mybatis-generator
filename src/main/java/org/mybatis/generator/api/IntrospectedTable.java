...
public abstract class IntrospectedTable {
    ...
    protected void calculateXmlAttributes() {
        ...
        setSelectByPrimaryKeyStatementId("selectOne"); //$NON-NLS-1$
    ...
    public void setSelectList(String s) {
        internalAttributes.put(
    ...
    public String getSelectList() {
        return internalAttributes.get(InternalAttribute.ATTR_SELECT_LISt_STATEMENT_ID);
    }
